...
private:
    ...
    PureClassifierList(Classifier *cl) {
        this->cl = cl;
        next = 0;
    }
...
private:
    ...
    void freeBidisearchStuff(ClassifierList **al1, Perception **ap1, int size1, ClassifierList **al2, Perception **ap2,
                             int size2, ClassifierList *cllist);
