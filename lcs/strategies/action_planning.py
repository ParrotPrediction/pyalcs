...
forward_classifiers = []
backward_classifiers = []
forward_perceptions = []
backward_perceptions = []


def search_goal_sequence(reliable_classifiers, start, goal):
    """
    ...
    forward_perceptions.append(Perception(start))
    backward_perceptions.append(Perception(goal))
